...
# Content Intelligence System · v3
...
### 2. Generate benchmarks and planner data

Run both once — or whenever you add new posts to the CSV:
...
2. Place it in the `data/` folder (same filename, or update the path in `scoring/build_benchmarks.py`).
...
- [ ] Chart view: scatter plot of views vs SEO score for leadership reporting
- [ ] Export scored dataset to Excel
